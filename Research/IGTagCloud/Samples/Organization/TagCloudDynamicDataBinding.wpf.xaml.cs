...
{
    public partial class TagCloudDynamicDataBinding : Infragistics.Samples.Framework.SampleContainer
    {
        private TagViewModel viewModel;
        private XmlDataProvider xmlDataProvider;

        public TagCloudDynamicDataBinding()
        {
            InitializeComponent();
        ...
        private void dataTagCloud_XamTagCloudItemClicked(object sender, XamTagCloudItemEventArgs e)
        {
            ...
            if (selectedTag != null)
            {
                TagItem Tag = this.viewModel.Tags.FirstOrDefault(t => t.Content == selectedTag.Content.ToString());
                this.viewModel.FilterTags(Tag);
            }
        }
