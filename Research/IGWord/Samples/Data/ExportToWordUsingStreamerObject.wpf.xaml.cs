...
namespace IGWord.Samples.Data
{
    ...
    public partial class ExportToWordUsingStreamerObject : SampleContainer
    {
        ...
        string documentName = AppDomain.CurrentDomain.BaseDirectory + "\\SampleWordDocument.docx";
        ...
        private void btnImages_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                anchPic.AlternateTextDescription = strImagesAltTextDesc;
                ...
                docWriter.EndParagraph();
                docWriter.StartParagraph();
                docWriter.AddTextRun(strImagesSampleText2);
        ...
        private void btnNestedTable_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                docWriter.StartTableRow();
                cellProps.Reset();
                cellProps.BackColor = Colors.Snow;
                docWriter.StartTableCell(cellProps);
                docWriter.StartParagraph();
                ...
                docWriter.EndParagraph();
                docWriter.AddEmptyParagraph();
                BitmapSource ancImage = GetImage("Ballon_New_Year.jpg");

                // Create an Anchored Image
                AnchoredPicture anchPicInNestedTable = docWriter.CreateAnchoredPicture(ancImage);
                // Assign the picture outline properties for anchored image
                anchPicInNestedTable.HorizontalAlignment = AnchorHorizontalAlignment.Left;
                anchPicInNestedTable.Size = new Size(70, 70);
                anchPicInNestedTable.TextWrapping = AnchorTextWrapping.TopAndBottom;
                docWriter.StartParagraph();
                docWriter.AddAnchoredPicture(anchPicInNestedTable);
                docWriter.EndParagraph();
                docWriter.AddEmptyParagraph();
                docWriter.StartParagraph();
        ...
        private void btnShapes_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                ellipseShape.FillColor = Colors.Pink;
                ...
                rectangleShape.FillColor = Colors.LightYellow;
                ...
                // Set Shape Properties
                isoceleseTriangleShape.LineColor = Colors.Violet;
                isoceleseTriangleShape.LineWidth = 3;
                isoceleseTriangleShape.Size = new Size(120, 75);
                isoceleseTriangleShape.FillColor = Colors.LightCyan;
                // Start a Paragraph to add Inline Shape
                docWriter.StartParagraph();
                docWriter.AddNewLine();
                ...
                rightTriangleShape.FillColor = Colors.LightGreen;
        ...
        private void btnTable_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                cellProps.Reset();
                cellProps.BackColor = Colors.Bisque;
                ...
                docWriter.StartTableCell(cellProps);
                docWriter.StartParagraph();
                BitmapSource ancImage = GetImage("butterfly1.jpg");

                // Create an Anchored Image
                AnchoredPicture anchPicInTable = docWriter.CreateAnchoredPicture(ancImage);
                // Assign the picture outline properties for anchored image
                anchPicInTable.AlternateTextDescription = strTableImgAltTextDesc;
                docWriter.AddAnchoredPicture(anchPicInTable);
                docWriter.EndParagraph();
                docWriter.EndTableCell();
                docWriter.EndTableRow();
        ...
        {
            return new BitmapImage(new Uri(@"pack://application:,,,/IGWord;component/Resources/" + resourceName));
        }
        #endregion GetImage
    }
}
