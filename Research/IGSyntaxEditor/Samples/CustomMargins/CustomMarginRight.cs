...
{
    public class CustomMarginRight : MarginBase
    {
        #region Constants
        ...
        {
            get { return EditorDocumentViewMarginLocation.Right; }
        }
        ...
        {
            get { return "MyCustomMarginRight"; }
        }
        ...
        {
            return new CustomMarginRightPresenter(documentViewBase, this);
        }
