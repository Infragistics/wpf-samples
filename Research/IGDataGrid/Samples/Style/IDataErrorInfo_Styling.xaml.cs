...
{
    /// <summary>
    /// Interaction logic for IDataErrorInfo_Styling.xaml
    /// </summary>
    public partial class IDataErrorInfo_Styling : SampleContainer
    {
        public IDataErrorInfo_Styling()
        {
            InitializeComponent();
            InitializeSample();
        }
        ...
        {
            Type enumType = typeof(DataErrorDisplayMode);
            this.Resources.Add("enum_" + enumType.Name, Enum.GetValues(enumType));
