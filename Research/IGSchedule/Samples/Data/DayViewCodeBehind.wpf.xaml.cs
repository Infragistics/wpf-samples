...
{
    /// <summary>
    /// Interaction logic for DayViewCodeBehind.xaml
    /// </summary>
    public partial class DayViewCodeBehind : SampleContainer
    {
        public DayViewCodeBehind()
        {
            InitializeComponent();

            DataContext = new MyScheduleData();
            ((MyScheduleData)DataContext).DataLoadingCompleted += DayViewCodeBehind_DataLoadingCompleted;
            dtPicker.Value = DateTime.Now;
            this.dataManager.DialogFactory = new Infragistics.Controls.Schedules.ScheduleDialogFactory();
        }
        
        void DayViewCodeBehind_DataLoadingCompleted(object sender, EventArgs e)
        {
