...
{
    /// <summary>
    /// Interaction logic for ScheduleViewCustomizations.xaml
    /// </summary>
    public partial class ScheduleViewCustomizations : SampleContainer
    {
        public ScheduleViewCustomizations()
        {
            ...
            this.Loaded += new RoutedEventHandler(Customizations_Loaded);
        ...
        void Customizations_Loaded(object sender, RoutedEventArgs e)
        {
            this.scheduleView.CalendarDisplayMode = CalendarDisplayMode.Overlay;
        }
