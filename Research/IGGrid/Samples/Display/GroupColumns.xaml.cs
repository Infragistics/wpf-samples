...
{
    public partial class GroupColumns : SampleContainer
    {
        ...
        private void EnableColumnChooser_Click(object sender, RoutedEventArgs e)
        {
            if (EnableColumnChooser != null)
            {
                this.dataGrid.ColumnChooserSettings.AllowHiddenColumnIndicator = (bool)EnableColumnChooser.IsChecked;
                this.dataGrid.ColumnChooserSettings.AllowHideColumnIcon = (bool)EnableColumnChooser.IsChecked;
            }
        }
    }
}
