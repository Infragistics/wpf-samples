...
{
    public partial class CustomizingOuterRing : SampleContainer
    {
        public CustomizingOuterRing()
        {
            InitializeComponent();
        }
        ...
        private void RadialMenuList_SelectedValueChanged(object sender, Infragistics.Controls.Menus.RadialMenuListValueChangedEventArgs e)
        {
            if (this.xamRichTextEditor1 == null || this.xamRichTextEditor1.ActiveDocumentView == null) return;
