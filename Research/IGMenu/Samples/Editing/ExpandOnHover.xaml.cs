...
{
    public partial class ExpandOnHover : SampleContainer
    {
        ...
        private void EnableExpansionBehavior_Click(object sender, RoutedEventArgs e)
        {
            this.MainMenu.ExpandOnHover = (bool)this.EnableExpansionBehavior.IsChecked;
        }
    }
}
