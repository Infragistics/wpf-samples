...
namespace System
{
    ...
    public class Paint
    {
        ...
        public static Brush LinearBrush(bool isHorizontal, Color startColor, Color endColor)
        {
        ...
        public static Brush RadialBrush(Color startColor, Color endColor)
        {
        ...
        public static Paint FromString(string name)
        {
            ...
            if (name.IndexOf("rgba", 0) == 0)
            {
                ...
                ret.R = byte.Parse(parts[0]);
                ret.G = byte.Parse(parts[1]);
                ret.B = byte.Parse(parts[2]);
