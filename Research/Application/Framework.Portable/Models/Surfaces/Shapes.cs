...
namespace Infragistics.Framework
{
    ...
    public class PlainAtAngle : Shape3D
    {
        public PlainAtAngle()
        {
            this.Add(new Point3D { X = 40, Y = 0, Z = 100000 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 300000 });
            this.Add(new Point3D { X = 0, Y = 4,  Z = 500000 });
            this.Add(new Point3D { X = 0, Y = 0,  Z = 300000 });
        }
    }
    public class PlainFlatX : Shape3D
    {
        public PlainFlatX()
        {
            this.Add(new Point3D { X = 20, Y = 0, Z = 200000 });
            this.Add(new Point3D { X = 20, Y = 4, Z = 200000 });
            this.Add(new Point3D { X = 20, Y = 2, Z = 400000 }); 
        }
    }
    ...
    public class PlainUnevenRangeX : Shape3D
    {
        public PlainUnevenRangeX()
        {
            ...
            this.Add(new Point3D { X = 2.5, Y = 0, Z = 5 });
            this.Add(new Point3D { X = 2.5, Y = 4, Z = 5 });
            this.Add(new Point3D { X = 5, Y = 0, Z = 10 });
            this.Add(new Point3D { X = 5, Y = 4, Z = 10 });
        }
    }
    public class PlainFlatZ : Shape3D
    {
        public PlainFlatZ()
        {
            this.Add(new Point3D { X = 40, Y = 0, Z = 200000 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 200000 });
            this.Add(new Point3D { X = 0, Y = 4, Z = 200000 });
    ...
    public class PlainFlatY : Shape3D
    {
        public PlainFlatY()
        {
            this.Add(new Point3D { Y = 20, X = 0, Z = 200000 });
            this.Add(new Point3D { Y = 20, X = 4, Z = 200000 });
            this.Add(new Point3D { Y = 20, X = 2, Z = 400000 });
        }
    }
    public class Pyramid : Shape3D
    {
        ...
        {
            this.Add(new Point3D { X = 20, Y = 2, Z = 400000 });
            this.Add(new Point3D { X = 40, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 0 });
            this.Add(new Point3D { X = 0, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 0, Y = 4, Z = 0 });
        }
    }
    public class PyramidWithDoubles : Shape3D
    {
        ...
        {
            this.Add(new Point3D { X = 20.5, Y = 2.25, Z = 400000.5 });
            this.Add(new Point3D { X = 40.5, Y = 0.25, Z = 0.5 });
            this.Add(new Point3D { X = 40.5, Y = 4.25, Z = 0.5 });
            this.Add(new Point3D { X = 0.5,  Y = 0.25, Z = 0.5 });
            this.Add(new Point3D { X = 0.5,  Y = 4.25, Z = 0.5 });
        }
    }
    /// <summary>
    ...
    public class PyramidWithNaN : Shape3D
    {
        ...
        {
            this.Add(new Point3D { X = 20, Y = 2, Z = 400000 });
            this.Add(new Point3D { X = double.NaN, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 40, Y = 0, Z = 0 });
            this.Add(new Point3D { X = double.NaN, Y = double.NaN, Z = 0 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 0 });
            this.Add(new Point3D { X = double.NaN, Y = double.NaN, Z = double.NaN });
            this.Add(new Point3D { X = 0, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 0, Y = double.NaN, Z = double.NaN });
            this.Add(new Point3D { X = 0, Y = 4, Z = 0 });
        }
    }
    /// <summary>
    ...
    public class PyramidWithInfinity : Shape3D
    {
        ...
        {
            this.Add(new Point3D { X = 20, Y = 2, Z = 400000 });
            this.Add(new Point3D { X = double.PositiveInfinity, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 40, Y = 0, Z = 0 });
            this.Add(new Point3D { X = double.NegativeInfinity, Y = double.PositiveInfinity, Z = 0 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 0 });
            this.Add(new Point3D { X = double.NegativeInfinity, Y = double.NegativeInfinity, Z = double.PositiveInfinity });
            this.Add(new Point3D { X = 0, Y = 0, Z = 0 });
            this.Add(new Point3D { X = 0, Y = double.PositiveInfinity, Z = double.NegativeInfinity });
            this.Add(new Point3D { X = 0, Y = 4, Z = 0 });
        }
    }
    /// <summary>
    ...
    public class PyramidWithMixedValues : Shape3D
    {
        public PyramidWithMixedValues()
        {
            ...
            this.Add(null);
            this.Add(new Point3D { X = 40, Y = 4, Z = 0 });
            this.Add(new Point3D { X = double.NaN, Y = double.NegativeInfinity, Z = double.PositiveInfinity });
            this.Add(null);
            this.Add(new Point3D { X = 0, Y = 0, Z = 0 });
            this.Add(null);
            this.Add(new Point3D { X = 0, Y = double.PositiveInfinity, Z = double.NaN });
            this.Add(new Point3D { X = 0, Y = 4, Z = 0 });
        }
    }
    ...
    public class Tetrahedron : Shape3D
    {
        public Tetrahedron() 
        {
            ...
            this.Add(new Point3D { X = 0, Y = 0, Z = 100000 });
            this.Add(new Point3D { X = 40, Y = 0, Z = 100000 });
            this.Add(new Point3D { X = 20, Y = 4, Z = 100000 });
        }
    }
    ...
    public class Trapezoid : Shape3D
    {
        public Trapezoid()
        {
            this.Add(new Point3D { X = 30, Y = 2, Z = 400000 });
            this.Add(new Point3D { X = 30, Y = 3, Z = 400000 });
            this.Add(new Point3D { X = 20, Y = 3, Z = 400000 });
            this.Add(new Point3D { X = 20, Y = 2, Z = 400000 });

            this.Add(new Point3D { X = 40, Y = 1, Z = 100000 });
            this.Add(new Point3D { X = 40, Y = 4, Z = 100000 });
            this.Add(new Point3D { X = 10, Y = 4, Z = 100000 });
            this.Add(new Point3D { X = 10, Y = 1, Z = 100000 });
        }
    }
    ...
    public class Cone : Shape3D
    {
        ...
        {
            var radius = 4;
            var center = new Point2D(radius / 2.0, radius / 2.0);
            Generate(center, radius, 1, points);
            this.Add(new Point3D { X = radius / 2.0, Y = radius / 2.0, Z = 4 });

        }
        public void Generate(Point2D center, double radius, double z, int points = 10)
        {
            var interval = 360.0 / points;
            for (var i = 0.0; i <= 360.0; i += interval)
            {
                var p = GetPoint(i, radius / 2.0, center);
                this.Add(new Point3D { X = p.X, Y = p.Y, Z = z });
            }
        }

        private Point2D GetPoint(double angle, double distance, Point2D centre)
        {
    ...
    public class Cube : Shape3D
    {
        ...
        {  
            ...
            this.Add(new Point3D { X = 4, Y = 0, Z = 4 });
            this.Add(new Point3D { X = 4, Y = 4, Z = 4 });
            this.Add(new Point3D { X = 0, Y = 4, Z = 4 });
            this.Add(new Point3D { X = 0, Y = 0, Z = 4 });  
        } 
    } 
}