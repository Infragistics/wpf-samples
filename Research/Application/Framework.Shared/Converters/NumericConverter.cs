...
//{
    ...
    {
        /// <summary> Specifies numbers in no form, 5200 for 5200 </summary>
        None,
        /// <summary> Specifies numbers in comma separated form, 5,200 for 5200 </summary>
        CSV,
        /// <summary> Specifies numbers in form of "N:0.0 Symbol", where N is multiplier of "k", "M", "G", "T", or "P" symbol </summary>
        Metric,
        /// <summary> Specifies numbers in form of "N:0.0 Symbol", where N is multiplier of "K", "M", "B", "T", or "Q" symbol </summary>
        Financial,
        /// <summary> Specifies numbers in form of "10^P" (ten raised to P power) </summary>
        Power10,
        /// <summary> Specifies numbers in form of "N:0.0 x10^P" (N times ten raised to P power), e.g. 5.2 x10^3 is 5200 </summary>
        Power10X,
        /// <summary> Specifies numbers in form of "N:0.0 E+P" (N times ten raised to P power), e.g. 5.2 E+3 is 5200 </summary>
        ScientificE,
        /// <summary> Specifies numbers in form of "N:0.0 E+0P" (N times ten raised to P power), e.g. 5.2 E+03 is 5200 </summary>
        ScientificE0,
        /// <summary> Specifies numbers in form of "N:0.0 E+00P" (N times ten raised to P power), e.g. 5.2 E+003 is 5200 </summary>
        ScientificE00,
        /// <summary> Specifies numbers in form of Hexadecimal, 0000014D is 333 </summary>
        Hexadecimal,
    ...
    public static class ConvertUtil
    {
        static ConvertUtil()
        {
            ...
            //LargeUnits[Notation.CSV] = new[] { "" };
            //SmallUnits[Notation.CSV] = new[] { "" };
            ...
            double thresholdMax = double.NaN)
        {
            ...
            {         
                ...
                // skip conversion if the number is within threshold range
                ...
                if (notation == Notation.None)
                {
                    ...
                    return number.ToString("0." + format);
                }
                ...
                else if (notation == Notation.CSV)
                {
                    var result = number.ToString("#,##0");
                    Debug.WriteLine(result + " <- " + number + " " + notation + "");
                    return result;
                }
                ...
                if (notation == Notation.Power10X)
                {
                    ...
                    else
                    {
                        ...
                        var format = new string('0', precission - 1);
