...
namespace System
{
    ...
    {
        public static SolidColorBrush ToSolidBrush(this string colorHex, double opacity = double.NaN)
        {
            var color = Xamarin.Forms.Color.FromHex(colorHex);
            return Xamarin.Forms.ColorEx.ToSolidBrush(color, opacity);
        }
    }
}
...
namespace Xamarin.Forms
{
    ...
    public class Colors
    {
        ...
        //public string FriendlyName { protected internal set; get; }
        //public string NameInfo { protected internal set; get; }
        public string Name { protected internal set; get; }
        public Color Color { protected internal set; get; }

        private static List<Colors> GetColors()
        {
            var all = new List<Colors>();
            return all;
        }
        private static List<Colors> _all = new List<Colors>();

        public static IEnumerable<Colors> All
        {
            get { if (_all == null) _all = GetColors(); return _all; }
        }

        //TODO add colors from BDD Framework
