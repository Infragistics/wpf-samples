...
{
    [TemplatePart(Name = "PART_ListBox", Type = typeof(ListView))]
    ...
    public class HightlightColorTool : Button, IRibbonTool
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            listView = (ListBox)this.GetTemplateChild("PART_ListBox");
        ...
        #region NoColorItemText

        public static readonly DependencyProperty NoColorItemTextProperty = DependencyProperty.Register("NoColorItemText",
                  typeof(string), typeof(HightlightColorTool), new PropertyMetadata(null));

        public string NoColorItemText
        {
            get
            {
                return (string)this.GetValue(HightlightColorTool.NoColorItemTextProperty);
            }
            set
            {
                this.SetValue(HightlightColorTool.NoColorItemTextProperty, value);
            }
        }

        #endregion //NoColorItemText
