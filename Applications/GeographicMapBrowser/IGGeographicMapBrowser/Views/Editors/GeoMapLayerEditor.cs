...
{
    public class GeoMapLayerEditor : UserControl
    {
        ...
        public static readonly DependencyProperty MapLayerProperty = DependencyProperty.Register(
            MapLayerPropertyName, typeof(GeoMapDataLayer), typeof(Views.GeoMapLayerEditor), new PropertyMetadata(null, (sender, e) =>
            {
                (sender as Views.GeoMapLayerEditor).OnPropertyChanged(new PropertyChangedEventArgs(MapLayerPropertyName));
            }));
        /// <summary>
