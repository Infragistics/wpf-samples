...
namespace IGComboEditor.Samples.Editing
{
    public class PatientsDataProvider : ObservableModel
    {
        ...
        private void SetSelectedDataPropertiesOptions()
        {
            ...
            options.Add(new SelectedDataProperty("HasAllergies", ComboEditorStrings.CE_Allergies));
            options.Add(new SelectedDataProperty("TakeMedications", ComboEditorStrings.CE_ExtaMeds));
