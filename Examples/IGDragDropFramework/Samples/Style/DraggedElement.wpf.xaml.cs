...
namespace IGDragDropFramework.Samples.Style
{
    public partial class DraggedElement : SampleContainer
    {
        ...
        private void Image_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                senderAsImage.Height = this.firstImage.ActualHeight;
                senderAsImage.Width = this.firstImage.ActualWidth;
            }
        }
    }
}