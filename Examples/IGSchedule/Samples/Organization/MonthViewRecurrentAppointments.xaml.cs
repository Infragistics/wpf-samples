...
{
    /// <summary>
    /// Interaction logic for MonthViewRecurrentAppointments.xaml
    /// </summary>
    public partial class MonthViewRecurrentAppointments : SampleContainer
    {
        ScheduleData data = null;

        public MonthViewRecurrentAppointments()
        {
            InitializeComponent();
