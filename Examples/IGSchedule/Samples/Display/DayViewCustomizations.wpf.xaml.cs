...
{
    /// <summary>
    /// Interaction logic for DayViewCustomizations.xaml
    /// </summary>
    public partial class DayViewCustomizations : SampleContainer
    {
        public DayViewCustomizations()
        {
            InitializeComponent();
        ...
        {
            dayView.WeekDisplayMode = (WeekDisplayMode)cboDisplayMode.SelectedIndex;
            if (dtPicker != null)
            {
                dtPicker.IsEnabled = dayView.WeekDisplayMode == WeekDisplayMode.None;
                LoadVisibleDates();
            }
        }
        ...
        private void cboTimeslotInterval_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (!int.TryParse(selMinutes, out minutes))
                minutes = 15;
            dayView.TimeslotInterval = new System.TimeSpan(0, minutes, 0);
        }
