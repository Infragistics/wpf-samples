...
{
    /// <summary>
    /// Interaction logic for MonthViewTheming.xaml
    /// </summary>
    public partial class MonthViewTheming : SampleContainer
    {
        ...
        {
            InitializeComponent();
            this.Loaded += new RoutedEventHandler(MonthViewTheming_Loaded);
            this.Unloaded += new RoutedEventHandler(MonthViewTheming_Unloaded);
        }

        void MonthViewTheming_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        void MonthViewTheming_Unloaded(object sender, RoutedEventArgs e)
        {
