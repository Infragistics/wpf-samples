...
namespace IGSchedule.Samples.Style
{
    ...
    public partial class ScheduleViewTheming : SampleContainer
    {
        ...
        {
            InitializeComponent();
            this.Loaded += new RoutedEventHandler(ScheduleViewTheming_Loaded);
            this.Unloaded += new RoutedEventHandler(ScheduleViewTheming_Unloaded);
        }

        void ScheduleViewTheming_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        void ScheduleViewTheming_Unloaded(object sender, RoutedEventArgs e)
        {
